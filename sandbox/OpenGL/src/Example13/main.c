...
/**
 * GLEW is used to map all OpenGL 4 functions.
 */
#include <GL/glew.h>
...
GLUSboolean init(GLUSvoid)
{
	...
	glusInverseMatrixf(worldToTexture, textureToWorld);

	glusInverseMatrixf(worldToTextureNormal, textureToWorldNormal);
...
int main(int argc, char* argv[])
{
	...
	// Only continue, if OpenGL 4.1 is supported.
