/**
 * OpenGL 3.3 with GLEW - Example 05
 *
...
/**
 * GLEW is used to retrieve all OpenGL 3.3 functions.
 */
#include <GL/glew.h>
...
GLUSboolean init(GLUSvoid)
{
	...
	glusLoadTextFile("../src/Example05/Vertex.vs", &vertexSource);

	// Load the source of the fragment shader.
	glusLoadTextFile("../src/Example05/Fragment.fs", &fragmentSource);
