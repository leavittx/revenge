/**
 * OpenGL 3.2 with GLEW - Example 03
 *
...
{
	// Points of a cube.
	GLfloat points[] = {  -0.5f, -0.5f, -0.5f, 1.0f,
						  -0.5f, -0.5f, +0.5f, 1.0f,
						  +0.5f, -0.5f, +0.5f, 1.0f,
						  +0.5f, -0.5f, -0.5f, 1.0f,
						  -0.5f, +0.5f, -0.5f, 1.0f,
	...
	glusLoadTextFile("../Example03/Vertex.vs", &vertexSource);

	// Load the source of the fragment shader.
	glusLoadTextFile("../Example03/Fragment.fs", &fragmentSource);
