/**
 * OpenGL 3.2 with GLEW - Example 09
 *
...
GLUSboolean init(GLUSvoid)
{
	...
	glusLoadTextFile("../Example09/Vertex.vs", &vertexSource);

	// Load the source of the geometry shader.
	glusLoadTextFile("../Example09/Geometry.gs", &geometrySource);

	// Load the source of the fragment shader.
	glusLoadTextFile("../Example09/Fragment.fs", &fragmentSource);

	// Build and ...
	glusBuildProgram(&g_program, (const GLUSchar**)&vertexSource.text, (const GLUSchar**)&geometrySource.text, (const GLUSchar**)&fragmentSource.text);
